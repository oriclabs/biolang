# BioPeek Chrome Extension - Build and Package Script
# Usage:
...
Write-Host ""
Write-Host "  BioPeek Chrome Extension v$Version" -ForegroundColor Cyan
...
if ($Zip) {
    $zipName = "biopeek-chrome-v$Version.zip"
    ...
    $staging = "$env:TEMP\biopeek-staging"
