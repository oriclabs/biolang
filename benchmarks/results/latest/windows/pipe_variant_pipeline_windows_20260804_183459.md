...
|---|---|---|---|---|---|
| Variant Analysis Pipeline | 0.102 | 0.147 | - | 1.4x | - |
| ClinVar Variant Pipeline | 0.152 | 0.144 | - | 0.9x | - |
...
Variant Pipeline (ClinVar Real Data):
  Chromosomes analyzed: 24
  14: 1000 variants (1000 SNPs, 0 indels)
  8: 1000 variants (972 SNPs, 28 indels)
  16: 1000 variants (907 SNPs, 93 indels)
  21: 1000 variants (973 SNPs, 27 indels)
  11: 1000 variants (978 SNPs, 22 indels)
```
