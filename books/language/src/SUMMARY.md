...
- [Bio Literals & Sequences](./ch02-bio-literals.md)
- [Variables, Types & Records](./ch03-variables-types.md)
- [Collections & Tables](./ch04-collections-tables.md)
- [Pipes & Transforms](./ch05-pipes-transforms.md)
- [Functions & Closures](./ch06-functions-closures.md)
- [Control Flow](./ch07-control-flow.md)
- [Error Handling](./ch08-error-handling.md)

# Working with Biology

- [File I/O](./ch09-file-io.md)
- [Genomic Intervals & Variants](./ch10-intervals-variants.md)
...
- [Benchmarks & Correctness](./ch19-benchmarks.md)

# Appendix

- [Builtin Reference](./appendix-builtins.md)
